...
export default function NotFound() {
  return (
    <main data-testid="page-not-found" className="relative min-h-screen overflow-hidden bg-white px-5 py-8 text-[#15171c]">
      <div className="absolute right-[7%] top-6 hidden items-center gap-2 rounded-full bg-[#f7f7f7] px-3 py-1.5 text-[10px] font-extrabold uppercase text-[#303237] shadow-sm sm:inline-flex">
      ...
      <section className="relative mx-auto grid min-h-[32rem] max-w-5xl items-center gap-9 pt-16 lg:grid-cols-[21rem_minmax(0,1fr)] lg:gap-14 lg:pt-20">
        <div className="relative mx-auto h-[22rem] w-full max-w-[21rem]">
          ...
          <div className="absolute bottom-2 left-1/2 z-10 h-[13.7rem] w-[13.7rem] -translate-x-1/2 rounded-full border-2 border-dashed border-orange-200 p-3">
            <div
              role="img"
              aria-label="A Blackey resting with a chew bone"
        ...
        <div className="relative z-10 max-w-[34rem] text-center lg:text-left">
          ...
          <p className="mt-4 max-w-[31rem] text-sm font-medium leading-6 text-[#73757c]">
            Our energetic Blackey spotted a squirrel (or maybe a rogue line of code) and bolted right off the map, taking your requested link with him. Don&apos;t worry, we&apos;re tracking his treats back to safety.
          </p>
